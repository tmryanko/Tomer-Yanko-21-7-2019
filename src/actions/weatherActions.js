...
export const getAutoComplete = (e) => (dispatch) => {
    axios.get(`${AT.LINK}locations/v1/cities/autocomplete?apikey=${AT.API_KEY}&q=${e}`)
    .then((res) => {
...
export const getFiveDayWeather = (id) => (dispatch) => {
    axios.get(`${AT.LINK}forecasts/v1/daily/5day/${id}?apikey=${AT.API_KEY}`)
    .then((res) => {
...
export const getCurrentWeather = (id) => (dispatch) => {
    axios.get(`${AT.LINK}currentconditions/v1/${id}?apikey=${AT.API_KEY}`)
    .then((res) => {
